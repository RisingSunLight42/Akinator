...
def lesquels(question, arbre):
    """Renvoie une liste des animaux vérifiant la question donnée

    Args:
        question (str): Question dont l'on souhaite connaître les animaux pour lesquels la réponse est "oui"
        arbre (list): Arbre que l'on souhaite tester

    Returns:
        list: Liste des animaux répondant à la question
    """
